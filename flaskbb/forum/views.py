    ...
    def post(self, forum_id, slug=None):  # noqa: C901
        ...
        # deleting
            ...
            if not Permission(CanDeleteTopic):
                ...
                changed = TopicManager.delete(topics=tmp_topics)
        ...
        # moving
            ...
            elif new_forum.move_topics_to(tmp_topics):
        ...
        # hiding/unhiding
            ...
            if not Permission(Has("makehidden")):
                ...
                changed = TopicManager.hide(topics=tmp_topics, user=real(current_user))
            ...
            if not Permission(Has("makehidden")):
                ...
                changed = TopicManager.unhide(topics=tmp_topics)
